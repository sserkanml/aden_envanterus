...
mixin _$ProjectService on _ProjectServiceBase, Store {
  Computed<int>? _$getProjectLengthComputed;

  @override
  int get getProjectLength => (_$getProjectLengthComputed ??= Computed<int>(
          () => super.getProjectLength,
          name: '_ProjectServiceBase.getProjectLength'))
      .value;
